...
<title>Upload Curriculum Vitae</title>
</head>
<body>
	<h2>CS Jobs</h2>
		...
		<div class="container" style="width: 50%; float: centre;">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Upload Curriculum Vitae</h3>
				</div>
				<div class="panel-body">
					<form action="uploadCV.html?${_csrf.parameterName}=${_csrf.token}" method="post"
						...
						<table class="table table-striped table-hover">
							...
							<tr><td><input type="file" name="file" class="btn btn-default" /></td>
								...
								<td><a href="uploadRS.html" class="btn btn-default">Skip</a></td>
							</tr>
						</table>
					</form>
				</div>
