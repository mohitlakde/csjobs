...
<title>Upload Teaching Statement</title>
</head>
<body>
	<h2>CS Jobs</h2>
		...
		<div class="container" style="width: 50%; float: centre;">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Upload Teaching Statement</h3>
				</div>
				<div class="panel-body">
					<form action="uploadTS.html?${_csrf.parameterName}=${_csrf.token}" method="post"
						...
						<table class="table table-striped table-hover">
							...
							<tr><td><input type="file" name="file" class="btn btn-default" /></td>
								<td><input type="submit" name="save" value="save" class="btn btn-default"/></td>
								<td><a href="addDegree.html" class="btn btn-default">Skip</a></td>
							</tr>
